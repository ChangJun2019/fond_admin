export default {
  ...
  'form.title.label': '文章标题',
  'form.title.placeholder': '请输入文章标题',
  'form.sort.label': '主题选择',
  'validation.sort.required':'必须选择主题',
  'form.cover.label':'文章封面',
  'Click to upload':'点击上传',
  'form.date.label': '起止日期',
  'validation.cover.required':'请选择要上传的图片',
  'form.sort.placeholder':"请选择分类",
  'form.article.label.content':'文章正文',
  'form.state.label':'动态内容',
  'validation.state.content.required':'内容格式填写错误',
  'form.state.content.placeholder':'请输入您的动态内容，最大字符150个字',
  'form.videosrc.label':'视频播放地址',
  'validation.video.required':'您还没有填写视频播放地址',
  'form.video.placeholder':'请填写可以播放的视频地址',
  ...
  'form.article.label.type': '文章类型',
  'form.article.label.help': '文章类型是否是原创、转载、翻译',
  'form.article.radio.original': '原创',
  'form.article.radio.reprint': '转载',
  'form.article.radio.translate': '翻译',
